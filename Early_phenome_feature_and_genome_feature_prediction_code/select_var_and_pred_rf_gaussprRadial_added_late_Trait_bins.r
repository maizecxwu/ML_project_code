...
write.table(Result_All, paste0("~/machine_learning_project/Early_Phenomics_Bin/result/", MM, "_1_10_results_rf.txt"),
  row.names = F,
  col.names = T, sep = "\t", quote = F
)

write.table(Resample_All, paste0("~/machine_learning_project/Early_Phenomics_Bin/result/", MM, "_1_10_resample_rf.txt"),
  row.names = F,
  col.names = T, sep = "\t", quote = F
) 

write.table(as.data.frame(do.call(cbind, Fit$control$index)),
  paste0("~/machine_learning_project/Early_Phenomics_Bin/result/", MM, "_1_10_train_rf.txt"),
  row.names = F,
  col.names = T, sep = "\t", quote = F
) 

write.table( IMP_Overall_All , paste0("~/machine_learning_project/Early_Phenomics_Bin/result/", MM, "_1_10_IMP_Overall_rf.txt"),
  row.names = F,
  col.names = T, sep = "\t", quote = F
) 
