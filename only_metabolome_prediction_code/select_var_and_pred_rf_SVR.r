...
write.table(Result, paste0("~/machine_learning_project/Meta_analysis/FS_result/", MM, "_1_29_results_rf.txt"),
  row.names = F,
  col.names = T, sep = "\t", quote = F
) 

write.table(Resample, paste0("~/machine_learning_project/Meta_analysis/FS_result/", MM, "_1_29_resample_rf.txt"),
  row.names = F,
  col.names = T, sep = "\t", quote = F
) 
...
write.table(IMP_Overall, paste0("~/machine_learning_project/Meta_analysis/FS_result/", MM, "_1_29_IMP_Overall_rf.txt"),
  row.names = F,
  col.names = T, sep = "\t", quote = F
) 
