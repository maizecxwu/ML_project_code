...
write.table(Result, paste0("~/machine_learning_project/bin_inf_predict_yield/FS_result/", MM, "_1_29_results_rf.txt"),
  row.names = F,
  col.names = T, sep = "\t", quote = F
)

write.table(Resample, paste0("~/machine_learning_project/bin_inf_predict_yield/FS_result/", MM, "_1_29_resample_rf.txt"),
  row.names = F,
  col.names = T, sep = "\t", quote = F
) 
